...
//                     return (item.regDate.email.toLowerCase() === email.toLowerCase() && item.regDate.password === password);
//                 });
//
//                 if (!user) {
//                     return null;
//                 }
//
//                 user.regDate.password = undefined;
//                 return user;
//             })
//         );
//
...
//         user.authorization = 'access-token-' + Math.random();
...
//                     return (item.regDate.email.toLowerCase() === email.toLowerCase());
//                 });
//
//                 if (!user) {
//                     return null;
...
//
//                 const user = find(result, (item: User) => {
//                     return (item.authorization === userToken.toString());
//                 });
//
//                 if (!user) {
//                     return null;
