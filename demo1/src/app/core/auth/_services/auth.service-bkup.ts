...
// 		return this.http.post<User>(API_USERS_URL + '/registration', user.regDate)
// 		// return this.http.post<User>(API_USERS_URL + '/registration', user.regDate, { headers: httpHeaders })
// 			.pipe(
// 				map((res: User) => {
// 					return res;
// 				}),
...
// 		let httpHeaders = new HttpHeaders();
// 		httpHeaders = httpHeaders.set('authorization',  userToken);
// 		return this.http.post<User[]>(API_USERS_URL + '/admin/user/get', {}, {headers: httpHeaders });
// 	}
//
